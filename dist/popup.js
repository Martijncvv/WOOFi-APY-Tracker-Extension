...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_cssWithMappingToString_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".info-field-values {\n\tdisplay: flex;\n\tjustify-content: space-between;\n\n\tpadding: 10px 12px 6px;\n}\n.info-field-value {\n\tbox-sizing: border-box;\n\twidth: 33%;\n\n\t/* border: 1px solid green; */\n\n\tcolor: white;\n\tfont-size: 15px;\n\ttext-transform: capitalize;\n\ttext-overflow: ellipsis;\n\twhite-space: nowrap;\n}\n\n.info-field-value-2 {\n\tpadding: 0 0 0 24px;\n\t/* padding: 0 0 0 40px; */\n}\n.info-field-value-3 {\n\tdisplay: flex;\n\tjustify-content: flex-end;\n\ttext-transform: lowercase;\n}\n", "",{"version":3,"sources":["webpack://./src/components/InfoField/InfoField.css"],"names":[],"mappings":"AAAA;CACC,aAAa;CACb,8BAA8B;;CAE9B,sBAAsB;AACvB;AACA;CACC,sBAAsB;CACtB,UAAU;;CAEV,6BAA6B;;CAE7B,YAAY;CACZ,eAAe;CACf,0BAA0B;CAC1B,uBAAuB;CACvB,mBAAmB;AACpB;;AAEA;CACC,mBAAmB;CACnB,yBAAyB;AAC1B;AACA;CACC,aAAa;CACb,yBAAyB;CACzB,yBAAyB;AAC1B","sourcesContent":[".info-field-values {\n\tdisplay: flex;\n\tjustify-content: space-between;\n\n\tpadding: 10px 12px 6px;\n}\n.info-field-value {\n\tbox-sizing: border-box;\n\twidth: 33%;\n\n\t/* border: 1px solid green; */\n\n\tcolor: white;\n\tfont-size: 15px;\n\ttext-transform: capitalize;\n\ttext-overflow: ellipsis;\n\twhite-space: nowrap;\n}\n\n.info-field-value-2 {\n\tpadding: 0 0 0 24px;\n\t/* padding: 0 0 0 40px; */\n}\n.info-field-value-3 {\n\tdisplay: flex;\n\tjustify-content: flex-end;\n\ttext-transform: lowercase;\n}\n"],"sourceRoot":""}]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
const DexTradesField = ({}) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", null,
        ...
        dexTrades.map((tradeInfo, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { key: index, className: "dex-trades-values", style: parseInt(index) % 2
...
const TabsField = ({ chainsInfo, activeTabCallback, activeTab, }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "tabs-field" }, chainsInfo.map((tab, index) => (react__WEBPACK_IMPORTED_MODULE_1__.createElement("div", { className: "tab", key: index, onClick: () => handleTabClick(tab.chainId), style: tab.chainId === activeTab
            ...
            : { backgroundColor: '#313641' } },
        react__WEBPACK_IMPORTED_MODULE_1__.createElement("img", { className: "tab-image", src: tab.icon }),
        react__WEBPACK_IMPORTED_MODULE_1__.createElement("span", { className: "tab-name" }, tab.chainName))))));
};
