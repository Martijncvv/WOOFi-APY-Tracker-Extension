...
const App = () => {
    ...
    const [stakedWooAmount, setStakedWooAmount] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
    ...
    function getaWooFiEarnInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ;
                [bscNetworkFetchedInfo, avaxNetworkFetchedInfo] = yield Promise.all([
                    (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchBscNetworkInfo)(),
                    (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchAvaxNetworkInfo)(),
                ]);
    ...
    function getStakedWooInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ;
                [stakedWooBscFetchedInfo, stakedWooAvaxFetchedInfo] = yield Promise.all([
                    (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchWooBscStakedInfo)(),
                    (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchWooAvaxStakedInfo)(),
                ]);
            }
            catch (err) {
                console.log(err);
    ...
    function getWooNetworkInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            let wooNetworkfetchedInfo = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchWooNetworkInfo)();
    ...
    function getFuturesInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let wooNetworkfetchedFuturesInfo = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchWooNetworkFutureInfo)();
    ...
    function getWooFiVolumesInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            let bsc1DVolumefetchedInfo = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchBsc1DVolume)();
            let avax1DVolumefetchedInfo = yield (0,_utils_api__WEBPACK_IMPORTED_MODULE_11__.fetchAvax1DVolume)();
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
        ...
        wooNetworkInfo && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_InfoField__WEBPACK_IMPORTED_MODULE_5__.default, { index: 2, value_1: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_12__.amountFormatter)(wooNetworkInfo.data.amount)}`, value_2: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_12__.amountFormatter)(wooFi1DTotalVolume / Math.pow(10, 18))}`, value_3: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_12__.amountFormatter)(wooNetworkFuturesVolume)} `, value_4: `${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_12__.amountFormatter)(stakedWooAmount)} ` })),
        ...
        activeTab === 'avax' && avaxNetworkEarnInfo.length > 0 && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_InfoField__WEBPACK_IMPORTED_MODULE_5__.default, { index: 0, value_1: 'Total', value_2: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_12__.amountFormatter)(parseInt(avaxNetworkEarnTvl) / Math.pow(10, 18))}`, value_3: `#${avaxNetworkEarnInfo.length}`, value_4: '' }),
            sortQuotes(avaxNetworkEarnInfo).map((tokenInfo, index) => (react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_InfoField__WEBPACK_IMPORTED_MODULE_5__.default, { key: index, index: index + 1, value_1: tokenInfo.symbol.replaceAll('_', '-').replace('-LP', ''), value_2: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_12__.amountFormatter)(parseInt(tokenInfo.tvl) / Math.pow(10, tokenInfo.decimals))}`, value_3: `${tokenInfo.apy.toPrecision(3)}%`, value_4: '' }))))),
        activeTab === 'bnb' && bscNetworkEarnInfo.length > 0 && (react__WEBPACK_IMPORTED_MODULE_0__.createElement(react__WEBPACK_IMPORTED_MODULE_0__.Fragment, null,
            react__WEBPACK_IMPORTED_MODULE_0__.createElement(_components_InfoField__WEBPACK_IMPORTED_MODULE_5__.default, { index: 0, value_1: 'Total', value_2: `$${(0,_utils_amountFormatter__WEBPACK_IMPORTED_MODULE_12__.amountFormatter)(parseInt(bscNetworkEarnTvl) / Math.pow(10, 18))}`, value_3: `#${bscNetworkEarnInfo.length}`, value_4: '' }),
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["vendors-node_modules_react-dom_index_js","vendors-node_modules_mui_icons-material_CalculateOutlined_js-node_modules_mui_icons-material_-6618bd"], () => (__webpack_require__("./src/popup/popup.tsx")))
